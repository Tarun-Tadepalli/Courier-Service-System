...
<%
    ...
    Parcel parcel = parcelService.viewParcelByPid(pid);
    if (parcel != null) {
%>
    <form action="updateParcelAction.jsp" method="post">
        <input type="hidden" name="pid" value="<%= parcel.getPid() %>">
        <p>Parcel Name: <%= parcel.getPname() %></p>
        <p>Sender Name: <%= parcel.getSname() %></p>
        <p>Receiver Name: <%= parcel.getRname() %></p>
        <p>Shipping Type: <%= parcel.getShipping_type() %></p>
        <p>Status:
            <select name="status">
                <option value="Godown" <%= "Godown".equals(parcel.getStatus()) ? "selected" : "" %>>Godown</option>
                <option value="Dispatching" <%= "Dispatching".equals(parcel.getStatus()) ? "selected" : "" %>>Dispatching</option>
