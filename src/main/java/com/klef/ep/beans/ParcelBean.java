...
public class ParcelBean {
    @EJB(lookup = "java:global/EPProject/ParcelServiceImpl!com.klef.ep.services.ParcelService")
    ...
    public List<Parcel> getPlist() {
		return plist;
	}

	public void setPlist(List<Parcel> plist) {
		this.plist = plist;
	}
	...
	public void setLrn(String lrn) {
	 ...
	 @ManagedProperty(value = "#{dispatcherbean}")
	    private DispatcherBean dispatcherBean;
	    ...
	    public List<Dispatcher> getDispatcherList() {
	        if (dispatcherList == null) {
	            dispatcherList = dispatcherBean.getAllDispatchers();
	        }
	        return dispatcherList;
	    }

	    public void setDispatcherBean(DispatcherBean dispatcherBean) {
